        ...
        function changeColor() {
            ...
            var colors = ['yellow', 'brown', 'green', 'black', 'indigo', 'gold'];
        ...
        function addHighlight() {
            // Get the element
            var element = document.getElementById('style-text');
 var colors = ['yellow', 'brown', 'green', 'blue', 'indigo', 'gold'];
...
element.className='Highlight';
        ...
        function addNewElement() {
            ...
            newParagraph.style.borderRadius = '500px';
